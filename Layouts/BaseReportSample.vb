...
Public Class BaseReportSample
    Inherits GrapeCity.ActiveReports.SectionReport
    'Protected ReadOnly log As log4net.ILog = log4net.LogManager.GetLogger(System.Environment.MachineName + " : " + Me.GetType().Name) 'lg 13129
